...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 443:1
...
public final class TimeRange extends Message<TimeRange, TimeRange.Builder> {
  ...
  private static final class ProtoAdapter_TimeRange extends ProtoAdapter<TimeRange> {
    ...
    public int encodedSize(TimeRange value) {
      return (value.start != null ? ProtoAdapter.UINT64.encodedSizeWithTag(1, value.start) : 0)
          + (value.end != null ? ProtoAdapter.UINT64.encodedSizeWithTag(2, value.end) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, TimeRange value) throws IOException {
      if (value.start != null) ProtoAdapter.UINT64.encodeWithTag(writer, 1, value.start);
      if (value.end != null) ProtoAdapter.UINT64.encodeWithTag(writer, 2, value.end);
