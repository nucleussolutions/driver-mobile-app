...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 495:1
...
public final class TripDescriptor extends Message<TripDescriptor, TripDescriptor.Builder> {
  ...
  public TripDescriptor(String trip_id, String route_id, Integer direction_id, String start_time, String start_date, ScheduleRelationship schedule_relationship) {
    this(trip_id, route_id, direction_id, start_time, start_date, schedule_relationship, ByteString.EMPTY);
  }

  public TripDescriptor(String trip_id, String route_id, Integer direction_id, String start_time, String start_date, ScheduleRelationship schedule_relationship, ByteString unknownFields) {
  ...
  private static final class ProtoAdapter_TripDescriptor extends ProtoAdapter<TripDescriptor> {
    ProtoAdapter_TripDescriptor() {
      super(FieldEncoding.LENGTH_DELIMITED, TripDescriptor.class);
    }

    @Override
    public int encodedSize(TripDescriptor value) {
      return (value.trip_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.trip_id) : 0)
          + (value.route_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(5, value.route_id) : 0)
          + (value.direction_id != null ? ProtoAdapter.UINT32.encodedSizeWithTag(6, value.direction_id) : 0)
          + (value.start_time != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.start_time) : 0)
          + (value.start_date != null ? ProtoAdapter.STRING.encodedSizeWithTag(3, value.start_date) : 0)
          + (value.schedule_relationship != null ? ScheduleRelationship.ADAPTER.encodedSizeWithTag(4, value.schedule_relationship) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, TripDescriptor value) throws IOException {
      if (value.trip_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 1, value.trip_id);
      if (value.route_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 5, value.route_id);
      if (value.direction_id != null) ProtoAdapter.UINT32.encodeWithTag(writer, 6, value.direction_id);
      if (value.start_time != null) ProtoAdapter.STRING.encodeWithTag(writer, 2, value.start_time);
      if (value.start_date != null) ProtoAdapter.STRING.encodeWithTag(writer, 3, value.start_date);
      if (value.schedule_relationship != null) ScheduleRelationship.ADAPTER.encodeWithTag(writer, 4, value.schedule_relationship);
