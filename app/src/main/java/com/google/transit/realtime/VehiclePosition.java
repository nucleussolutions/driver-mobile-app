...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 282:1
...
public final class VehiclePosition extends Message<VehiclePosition, VehiclePosition.Builder> {
  ...
  public VehiclePosition(TripDescriptor trip, VehicleDescriptor vehicle, Position position, Integer current_stop_sequence, String stop_id, VehicleStopStatus current_status, Long timestamp, CongestionLevel congestion_level, OccupancyStatus occupancy_status) {
  ...
  public VehiclePosition(TripDescriptor trip, VehicleDescriptor vehicle, Position position, Integer current_stop_sequence, String stop_id, VehicleStopStatus current_status, Long timestamp, CongestionLevel congestion_level, OccupancyStatus occupancy_status, ByteString unknownFields) {
  ...
  public enum VehicleStopStatus implements WireEnum {
    ...
    public static final ProtoAdapter<VehicleStopStatus> ADAPTER = ProtoAdapter.newEnumAdapter(VehicleStopStatus.class);
  ...
  public enum CongestionLevel implements WireEnum {
    ...
    public static final ProtoAdapter<CongestionLevel> ADAPTER = ProtoAdapter.newEnumAdapter(CongestionLevel.class);
  ...
  public enum OccupancyStatus implements WireEnum {
    ...
    public static final ProtoAdapter<OccupancyStatus> ADAPTER = ProtoAdapter.newEnumAdapter(OccupancyStatus.class);
  ...
  private static final class ProtoAdapter_VehiclePosition extends ProtoAdapter<VehiclePosition> {
    ProtoAdapter_VehiclePosition() {
      super(FieldEncoding.LENGTH_DELIMITED, VehiclePosition.class);
    }

    @Override
    public int encodedSize(VehiclePosition value) {
      return (value.trip != null ? TripDescriptor.ADAPTER.encodedSizeWithTag(1, value.trip) : 0)
          + (value.vehicle != null ? VehicleDescriptor.ADAPTER.encodedSizeWithTag(8, value.vehicle) : 0)
          + (value.position != null ? Position.ADAPTER.encodedSizeWithTag(2, value.position) : 0)
          + (value.current_stop_sequence != null ? ProtoAdapter.UINT32.encodedSizeWithTag(3, value.current_stop_sequence) : 0)
          + (value.stop_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(7, value.stop_id) : 0)
          + (value.current_status != null ? VehicleStopStatus.ADAPTER.encodedSizeWithTag(4, value.current_status) : 0)
          + (value.timestamp != null ? ProtoAdapter.UINT64.encodedSizeWithTag(5, value.timestamp) : 0)
          + (value.congestion_level != null ? CongestionLevel.ADAPTER.encodedSizeWithTag(6, value.congestion_level) : 0)
          + (value.occupancy_status != null ? OccupancyStatus.ADAPTER.encodedSizeWithTag(9, value.occupancy_status) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, VehiclePosition value) throws IOException {
      if (value.trip != null) TripDescriptor.ADAPTER.encodeWithTag(writer, 1, value.trip);
      if (value.vehicle != null) VehicleDescriptor.ADAPTER.encodeWithTag(writer, 8, value.vehicle);
      if (value.position != null) Position.ADAPTER.encodeWithTag(writer, 2, value.position);
      if (value.current_stop_sequence != null) ProtoAdapter.UINT32.encodeWithTag(writer, 3, value.current_stop_sequence);
      if (value.stop_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 7, value.stop_id);
      if (value.current_status != null) VehicleStopStatus.ADAPTER.encodeWithTag(writer, 4, value.current_status);
      if (value.timestamp != null) ProtoAdapter.UINT64.encodeWithTag(writer, 5, value.timestamp);
      if (value.congestion_level != null) CongestionLevel.ADAPTER.encodeWithTag(writer, 6, value.congestion_level);
      if (value.occupancy_status != null) OccupancyStatus.ADAPTER.encodeWithTag(writer, 9, value.occupancy_status);
