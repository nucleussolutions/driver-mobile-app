...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 568:1
...
public final class VehicleDescriptor extends Message<VehicleDescriptor, VehicleDescriptor.Builder> {
  ...
  public VehicleDescriptor(String id, String label, String license_plate, ByteString unknownFields) {
  ...
  private static final class ProtoAdapter_VehicleDescriptor extends ProtoAdapter<VehicleDescriptor> {
    ProtoAdapter_VehicleDescriptor() {
    ...
    public int encodedSize(VehicleDescriptor value) {
      return (value.id != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.id) : 0)
          + (value.label != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.label) : 0)
          + (value.license_plate != null ? ProtoAdapter.STRING.encodedSizeWithTag(3, value.license_plate) : 0)
    ...
    public void encode(ProtoWriter writer, VehicleDescriptor value) throws IOException {
      ...
      if (value.label != null) ProtoAdapter.STRING.encodeWithTag(writer, 2, value.label);
      if (value.license_plate != null) ProtoAdapter.STRING.encodeWithTag(writer, 3, value.license_plate);
