...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 588:1
...
public final class EntitySelector extends Message<EntitySelector, EntitySelector.Builder> {
  ...
  public EntitySelector(String agency_id, String route_id, Integer route_type, TripDescriptor trip, String stop_id) {
    this(agency_id, route_id, route_type, trip, stop_id, ByteString.EMPTY);
  }

  public EntitySelector(String agency_id, String route_id, Integer route_type, TripDescriptor trip, String stop_id, ByteString unknownFields) {
  ...
  private static final class ProtoAdapter_EntitySelector extends ProtoAdapter<EntitySelector> {
    ProtoAdapter_EntitySelector() {
      super(FieldEncoding.LENGTH_DELIMITED, EntitySelector.class);
    }

    @Override
    public int encodedSize(EntitySelector value) {
      return (value.agency_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.agency_id) : 0)
          + (value.route_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.route_id) : 0)
          + (value.route_type != null ? ProtoAdapter.INT32.encodedSizeWithTag(3, value.route_type) : 0)
          + (value.trip != null ? TripDescriptor.ADAPTER.encodedSizeWithTag(4, value.trip) : 0)
          + (value.stop_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(5, value.stop_id) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, EntitySelector value) throws IOException {
      if (value.agency_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 1, value.agency_id);
      if (value.route_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 2, value.route_id);
      if (value.route_type != null) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.route_type);
      if (value.trip != null) TripDescriptor.ADAPTER.encodeWithTag(writer, 4, value.trip);
      if (value.stop_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 5, value.stop_id);
