...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 52:1
...
public final class FeedHeader extends Message<FeedHeader, FeedHeader.Builder> {
  ...
  public FeedHeader(String gtfs_realtime_version, Incrementality incrementality, Long timestamp, ByteString unknownFields) {
  ...
  public enum Incrementality implements WireEnum {
    ...
    public static final ProtoAdapter<Incrementality> ADAPTER = ProtoAdapter.newEnumAdapter(Incrementality.class);
  ...
  private static final class ProtoAdapter_FeedHeader extends ProtoAdapter<FeedHeader> {
    ...
    public int encodedSize(FeedHeader value) {
      return ProtoAdapter.STRING.encodedSizeWithTag(1, value.gtfs_realtime_version)
          + (value.incrementality != null ? Incrementality.ADAPTER.encodedSizeWithTag(2, value.incrementality) : 0)
          + (value.timestamp != null ? ProtoAdapter.UINT64.encodedSizeWithTag(3, value.timestamp) : 0)
    ...
    public void encode(ProtoWriter writer, FeedHeader value) throws IOException {
      ...
      if (value.incrementality != null) Incrementality.ADAPTER.encodeWithTag(writer, 2, value.incrementality);
      if (value.timestamp != null) ProtoAdapter.UINT64.encodeWithTag(writer, 3, value.timestamp);
