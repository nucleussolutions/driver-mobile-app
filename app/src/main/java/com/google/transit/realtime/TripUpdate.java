...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 137:1
...
public final class TripUpdate extends Message<TripUpdate, TripUpdate.Builder> {
  ...
  public TripUpdate(TripDescriptor trip, VehicleDescriptor vehicle, List<StopTimeUpdate> stop_time_update, Long timestamp, Integer delay) {
    this(trip, vehicle, stop_time_update, timestamp, delay, ByteString.EMPTY);
  }

  public TripUpdate(TripDescriptor trip, VehicleDescriptor vehicle, List<StopTimeUpdate> stop_time_update, Long timestamp, Integer delay, ByteString unknownFields) {
  ...
  public static final class StopTimeEvent extends Message<StopTimeEvent, StopTimeEvent.Builder> {
    ...
    private static final class ProtoAdapter_StopTimeEvent extends ProtoAdapter<StopTimeEvent> {
      ProtoAdapter_StopTimeEvent() {
        super(FieldEncoding.LENGTH_DELIMITED, StopTimeEvent.class);
      }

      @Override
      public int encodedSize(StopTimeEvent value) {
        return (value.delay != null ? ProtoAdapter.INT32.encodedSizeWithTag(1, value.delay) : 0)
            + (value.time != null ? ProtoAdapter.INT64.encodedSizeWithTag(2, value.time) : 0)
            + (value.uncertainty != null ? ProtoAdapter.INT32.encodedSizeWithTag(3, value.uncertainty) : 0)
            + value.unknownFields().size();
      }

      @Override
      public void encode(ProtoWriter writer, StopTimeEvent value) throws IOException {
        if (value.delay != null) ProtoAdapter.INT32.encodeWithTag(writer, 1, value.delay);
        if (value.time != null) ProtoAdapter.INT64.encodeWithTag(writer, 2, value.time);
        if (value.uncertainty != null) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.uncertainty);
  ...
  public static final class StopTimeUpdate extends Message<StopTimeUpdate, StopTimeUpdate.Builder> {
    ...
    public StopTimeUpdate(Integer stop_sequence, String stop_id, StopTimeEvent arrival, StopTimeEvent departure, ScheduleRelationship schedule_relationship) {
      this(stop_sequence, stop_id, arrival, departure, schedule_relationship, ByteString.EMPTY);
    }

    public StopTimeUpdate(Integer stop_sequence, String stop_id, StopTimeEvent arrival, StopTimeEvent departure, ScheduleRelationship schedule_relationship, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
    ...
    public enum ScheduleRelationship implements WireEnum {
      ...
      public static final ProtoAdapter<ScheduleRelationship> ADAPTER = ProtoAdapter.newEnumAdapter(ScheduleRelationship.class);
    ...
    private static final class ProtoAdapter_StopTimeUpdate extends ProtoAdapter<StopTimeUpdate> {
      ProtoAdapter_StopTimeUpdate() {
        super(FieldEncoding.LENGTH_DELIMITED, StopTimeUpdate.class);
      }

      @Override
      public int encodedSize(StopTimeUpdate value) {
        return (value.stop_sequence != null ? ProtoAdapter.UINT32.encodedSizeWithTag(1, value.stop_sequence) : 0)
            + (value.stop_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(4, value.stop_id) : 0)
            + (value.arrival != null ? StopTimeEvent.ADAPTER.encodedSizeWithTag(2, value.arrival) : 0)
            + (value.departure != null ? StopTimeEvent.ADAPTER.encodedSizeWithTag(3, value.departure) : 0)
            + (value.schedule_relationship != null ? ScheduleRelationship.ADAPTER.encodedSizeWithTag(5, value.schedule_relationship) : 0)
            + value.unknownFields().size();
      }

      @Override
      public void encode(ProtoWriter writer, StopTimeUpdate value) throws IOException {
        if (value.stop_sequence != null) ProtoAdapter.UINT32.encodeWithTag(writer, 1, value.stop_sequence);
        if (value.stop_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 4, value.stop_id);
        if (value.arrival != null) StopTimeEvent.ADAPTER.encodeWithTag(writer, 2, value.arrival);
        if (value.departure != null) StopTimeEvent.ADAPTER.encodeWithTag(writer, 3, value.departure);
        if (value.schedule_relationship != null) ScheduleRelationship.ADAPTER.encodeWithTag(writer, 5, value.schedule_relationship);
        writer.writeBytes(value.unknownFields());
      }
  ...
  private static final class ProtoAdapter_TripUpdate extends ProtoAdapter<TripUpdate> {
    ...
    public int encodedSize(TripUpdate value) {
      return TripDescriptor.ADAPTER.encodedSizeWithTag(1, value.trip)
          + (value.vehicle != null ? VehicleDescriptor.ADAPTER.encodedSizeWithTag(3, value.vehicle) : 0)
          ...
          + (value.delay != null ? ProtoAdapter.INT32.encodedSizeWithTag(5, value.delay) : 0)
          + value.unknownFields().size();
    }
    ...
    public void encode(ProtoWriter writer, TripUpdate value) throws IOException {
      ...
      if (value.vehicle != null) VehicleDescriptor.ADAPTER.encodeWithTag(writer, 3, value.vehicle);
      ...
      if (value.delay != null) ProtoAdapter.INT32.encodeWithTag(writer, 5, value.delay);
      writer.writeBytes(value.unknownFields());
    }
