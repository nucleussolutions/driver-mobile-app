...
// Source file: home/kevintan/driver-mobile-app/app/src/main/proto/gtfs-realtime.proto at 461:1
...
public final class Position extends Message<Position, Position.Builder> {
  ...
  public Position(Float latitude, Float longitude, Float bearing, Double odometer, Float speed, ByteString unknownFields) {
  ...
  private static final class ProtoAdapter_Position extends ProtoAdapter<Position> {
    ...
    public int encodedSize(Position value) {
      return ProtoAdapter.FLOAT.encodedSizeWithTag(1, value.latitude)
          ...
          + (value.bearing != null ? ProtoAdapter.FLOAT.encodedSizeWithTag(3, value.bearing) : 0)
          + (value.odometer != null ? ProtoAdapter.DOUBLE.encodedSizeWithTag(4, value.odometer) : 0)
          + (value.speed != null ? ProtoAdapter.FLOAT.encodedSizeWithTag(5, value.speed) : 0)
    ...
    public void encode(ProtoWriter writer, Position value) throws IOException {
      ...
      if (value.bearing != null) ProtoAdapter.FLOAT.encodeWithTag(writer, 3, value.bearing);
      if (value.odometer != null) ProtoAdapter.DOUBLE.encodeWithTag(writer, 4, value.odometer);
      if (value.speed != null) ProtoAdapter.FLOAT.encodeWithTag(writer, 5, value.speed);
